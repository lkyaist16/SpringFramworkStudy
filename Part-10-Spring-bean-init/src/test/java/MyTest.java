import com.po.AbstractTeaFactory;
...
public class MyTest {
    public static void main(String[] args) {
        ...
        System.out.println("Spring IoC容器获取AbstractTeaFactory");
        Tea tea2 = ((AbstractTeaFactory) applicationContext.getBean("abstractTeaFactory")).getTea();
        tea2.pointTeaName();
    }
}
